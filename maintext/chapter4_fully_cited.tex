...
Multiple skull-stripping techniques have been developed due to their success and effectiveness in improving diagnostic and prognostic accuracy \cite{kalavathiMethodsSkullStripping2016, fatimaStateoftheArtTraditionalMachine2020}.
...
A key drawback is that performance depends heavily on empirically tuned parameters related to the shape and size of the morphological structuring elements \cite{fatimaStateoftheArtTraditionalMachine2020}.
...
These methods register the subject MRI to one or more anatomical atlases, enabling the transfer of brain masks to the subject \cite{kalavathiMethodsSkullStripping2016, novosadAccurateRobustSegmentation2018}.
...
Hybrid approaches combine multiple algorithms or features to improve robustness and accuracy \cite{kalavathiMethodsSkullStripping2016, fatimaStateoftheArtTraditionalMachine2020}.
...
However despite their performance, deep learning methods showcase several limitations \cite{rehmanConventionalDeepLearning2020, fatimaStateoftheArtTraditionalMachine2020}:
\begin{itemize}
...
Major difficulties arise from \cite{kalavathiMethodsSkullStripping2016, fatimaStateoftheArtTraditionalMachine2020, novosadAccurateRobustSegmentation2019}:
