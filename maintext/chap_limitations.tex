...
In this study \cite{diogoEarlyDiagnosisAlzheimers2022} they documented that models trained on research-grade images from one set frequently fail when applied to clinical-grade images from hospital settings. Dinsdale et al. (2024) \cite{turrisiDeepLearningbasedAlzheimers2024} found that accuracy dropped to 71\% when models were tested on external datasets with different scanner configurations, compared to training data performance.
...
Alzheimer's disease itself shows substantial phenotypic heterogeneity. In  \cite{youngUncoveringHeterogeneityTemporal2018}, at least three distinct disease progression patterns were identified. Patients may present with predominantly hippocampal atrophy, predominantly cortical atrophy, or mixed patterns, with different sequences of regional involvement over time.
