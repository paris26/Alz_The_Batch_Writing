...
Even though Deep Learning has performed tremendously in many computer vision tasks and has become a methodology of choice for analyzing medical images \cite{geertlitjensSurveyDeepLearning2017}, these large networks usually require vast amounts of data in order to avoid overfitting. 
