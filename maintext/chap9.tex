...
AD is a complex pathology in which multiple factors contribute to neurodegeneration; early pathological signs, such as amyloid-beta ($A\beta_{42}$) deposition, can be observed up to 20 years prior to clinical symptoms \cite{batemanClinicalBiomarkerChanges2012a}. Nevertheless, \textbf{early prediction remains challenging due to subtle brain changes that are difficult to quantify} \cite{rathoreReviewNeuroimagingbasedClassification2017}.
